# dmgbuild settings for the Unified Dev disk image. The artwork in background.html is
...
files = [defines.get('app', 'UnifiedDev.app')]
...
# reports 1 after conversion. If a label still reads "UnifiedDev.app" anyway, that
...
# file on the system; a default Mac shows "Unified Dev". This was chased five times
# before it was measured, so measure the preference before touching the image.
hide_extension = ['UnifiedDev.app']
