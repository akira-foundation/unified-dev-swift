...
what changed after it.
  ...
  is now Accent and Current, one gradient each. Splitting a group is not a
...
def groups(small=False):
    ...
    return [
        ...
        ("Bleed", [{"name": "Current",
                   ...
                   {"name": "Accent",
                    "body": clipped(sp["a"](sheen("accent")), p),
                    "fill": fill("accent", UP, DOWN, *w["a"])}], BLEEDKEYS),
...
def body(small=False):
    ...
    lanes = (sp["a"](paint("accent", UP, DOWN, *w["a"]))
