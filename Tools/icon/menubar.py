...
Writes `Resources/AppMenuBar.pdf`, which `MenuBarStatusItem` loads out of the
...
def asset(name=CHOICE):
    ...
    out = os.path.join(RESOURCES, "AppMenuBar.pdf")
...
def sheet():
    ...
    draw.text((pad, 16), "Unified Dev in the menu bar: every candidate, each drawn at "
