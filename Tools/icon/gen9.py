...
def flush(small=False):
    ...
    layers = [
        ...
        ("Bleed", a(sheen("accent")) + b(sheen("current")), BLEEDKEYS),
...
def plate(small=False):
    ...
    a, b, c, h = _bands(small)
    p = _plate()
    fig = a(sheen("accent")) + b(sheen("current"))
    layers = [
    ...
    body = "".join([
        ...
        p(flat("fathom")),
        clipped("".join([
            a(sheen("accent")), b(sheen("current")),
            contact(c, a, d=(0, 26 * S), blur=13 * S, alpha=0.34),
            contact(c, b, d=(0, -26 * S), blur=13 * S, alpha=0.34),
            c(sheen("shallow")),
        ]), p),
...
def pierce(small=False):
    ...
    layers = [
        ("Mark", c(sheen("shallow")), MARKKEYS),
        ("Bleed", clipped(b(sheen("current")), p) + a(sheen("accent")), BLEEDKEYS),
        ("Plate", p(flat("fathom")), PLATEKEYS),
        ("Ground", fullbleed(flat("deep")), {}),
    ]
    body = "".join([
...
def tab(small=False):
    ...
    layers = [
        ("Mark", c(sheen("shallow")), MARKKEYS),
        ("Bleed", clipped(a(sheen("accent")) + b(sheen("current")), p), BLEEDKEYS),
        ("Plate", p(flat("fathom")), PLATEKEYS),
        ("Ground", fullbleed(flat("deep")), {}),
    ]
    body = "".join([
