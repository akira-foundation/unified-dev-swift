"""Geometry, palette and drawing helpers for the Unified Dev v7 icon set.
...
# ---------------------------------------------------------------- palette
C = dict(
    abyss="#061420", deep="#0B2438", fathom="#123B57", accent="#197593",
    current="#2AA3B4", unifieddev="#4FD8C4", shallow="#9BE9DC", foam="#E9F7F4",
    mist="#C9D6DC", slate="#5A6B76", paper="#FAFCFC",
)

RAMP = ["abyss", "deep", "fathom", "accent", "current", "unifieddev", "shallow", "foam"]
