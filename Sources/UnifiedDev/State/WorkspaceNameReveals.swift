...
/// in this app and not about the row in the database. Restarting Unified Dev must not replay it, and
...
final class WorkspaceNameReveals {
    ...
    /// Announce that Unified Dev, not the user, just renamed this workspace.
    ///
