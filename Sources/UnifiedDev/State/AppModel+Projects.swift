...
///
/// A project is a git repository the owner pointed Unified Dev at. It owns workspaces and nothing else,
...
extension AppModel {
    ...
    /// folder is a git repository with a commit in it, whether Unified Dev made it a moment ago or found
