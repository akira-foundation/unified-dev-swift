...
/// Looking for the artwork of projects that were added before Unified Dev knew how to look.
///
...
/// for are never touched, and artwork Unified Dev found is looked at again only when the file it found
