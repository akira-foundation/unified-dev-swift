...
extension AppModel {
    ...
    /// Unified Dev's own merge rules, whatever the project adds to them and the guard that refuses mid
    ...
    /// one out loud from the list Unified Dev already has. Two callers, one answer, decided once. This
    ...
    private func startWorkspaceForBridge(
        ...
        // the owner's own client, which has nothing to inherit and gets Unified Dev's defaults.
