...
/// Which of the applications Unified Dev knows about are installed.
///
...
enum InstalledApps {
    ...
    /// installing an editor and coming back to Unified Dev shows it without a relaunch.
    ...
    /// entry in that list somebody may have chosen deliberately, so an editor Unified Dev has never
