    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack(spacing: Metrics.spacingSmall) {
                ...
                // sized each control to its own glyph and left the gaps between them uneven.
                Menu {
                ...
                // the Unified Dev menu. The other two earn their place because neither is reachable any
