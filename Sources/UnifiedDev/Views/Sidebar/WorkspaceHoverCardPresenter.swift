...
final class WorkspaceHoverCardPresenter {
    ...
    private func watchForDismissal() {
        ...
        // Local, not global: this only has to know about events going to Unified Dev, and a global
        // monitor is a request for the accessibility permission that Unified Dev has no other reason to
