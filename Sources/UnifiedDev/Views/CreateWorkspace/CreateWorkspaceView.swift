...
struct CreateWorkspaceView: View {
    ...
    /// The pull request or branch this workspace opens on, or nil for the route Unified Dev has always
    ...
    /// meeting Unified Dev read "New workspace" and had to infer that a workspace is a worktree on disk.
    ...
    private var header: some View {
        HStack(spacing: Metrics.spacingSmall) {
            ...
            //
            // What the band is now is the sentence that was already after the title: "in unifieddev,
    ...
    private var hint: some View {
        if let checkout {
            ...
            // Unified Dev will name it, and the branch follows the name. A second sentence eight points
    ...
    ///
    /// A branch one of Unified Dev's own workspaces holds is not a refusal at all: the window has nothing
    ...
    /// goes to the workspace that has it when it is one of Unified Dev's. They used to be left out,
    ...
    /// cut by hand, is as visible as one of Unified Dev's own. See `BranchHolder`.
    ...
    private func create() {
        ...
        // naming a path that is not there only teaches the agent that Unified Dev lies about paths.
