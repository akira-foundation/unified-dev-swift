...
struct PullRequestBar: View {
    ...
    /// project's own conventions in context. Unified Dev only composes the turn. Reading the pull
    ...
    ///
    /// Nothing here runs git. Unified Dev does not write commit messages, so the whole of this is
    ...
    ///
    /// Nothing here runs `gh`, and that is the change this whole file was rewritten for. Unified Dev used
