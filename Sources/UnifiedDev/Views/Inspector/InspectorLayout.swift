...
extension View {
    ...
    /// file header.
    ///
    /// `.glass`, the system's own style for a small control sitting in a bar: the pull request
    /// bar, the tab row, the file header. It replaces `.accessoryBar`, which drew flat rather than
