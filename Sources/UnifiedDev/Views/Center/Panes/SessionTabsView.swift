...
struct SessionTabsView: View {
    ...
    var body: some View {
        ...
        return TabStrip(pane: Self.pane, selection: selectedID) {
            ...
            // the Finder's own bar does not have.
        } tabs: {
            HStack(spacing: 0) {
    ...
    private func toolTab(
        ...
        TabItemView(
            ...
            // What is on the tab, not what the tab is filed under. A browser showing "Akira"
    ...
    /// What a tool tab wears. Three of the four kinds have a glyph of Unified Dev's own; a browser wears
