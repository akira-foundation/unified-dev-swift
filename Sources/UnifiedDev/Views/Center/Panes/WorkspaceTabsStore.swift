...
/// `Core.TabSurgery`, because a store in `Sources/UnifiedDev` is a store the suite cannot reach.
@MainActor
@Observable
final class WorkspaceTabsStore {
    ...
    /// See `Core.StripOrder`, which carries the rule and what a lost defaults file costs.
