...
/// about in `AppDelegate.confirmQuit`. It is the same shape here for the same reason.
///
/// WHAT there is to lose is `Core.SessionClosure` rather than a line of `if` here, because it
