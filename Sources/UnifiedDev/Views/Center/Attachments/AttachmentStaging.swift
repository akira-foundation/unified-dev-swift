...
/// one: `.unifieddev/attachments/<id>/<name>`, relative to the staging root. That is what makes the
...
enum AttachmentStaging {
    /// Under the system temporary directory rather than in Unified Dev's application support, because
