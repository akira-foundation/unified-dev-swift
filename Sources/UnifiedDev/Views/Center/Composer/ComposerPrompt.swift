...
struct ComposerPrompt<Footer: View>: View {
    ...
    /// Opens a slash command's backing file. Conversations use a Unified Dev file tab; prompts shown
    ...
    var body: some View {
        ...
        // worth re-reading one. A skill written in another window while Unified Dev stayed open is in
