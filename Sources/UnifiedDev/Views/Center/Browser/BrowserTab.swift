...
/// The one way an address gets into Unified Dev's own browser.
///
...
enum BrowserTab {
    ...
    /// Unified Dev open it. A reader right clicking a row of their own worktree is the one caller that
