...
final class BrowserFaviconStore {
    ...
    /// square the page was asked for. Both are impossible from a canvas Unified Dev sized and both are
    ...
    private static func image(from png: Data) -> NSImage? {
        ...
        // can put something indistinguishable from a control Unified Dev drew into Unified Dev's own strip.
