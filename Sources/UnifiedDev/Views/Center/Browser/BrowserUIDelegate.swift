...
final class BrowserUIObserver: NSObject, WKUIDelegate {
    ...
    ///
    /// **Nil is returned and a Unified Dev browser tab is opened instead, which is a decision rather
    ...
    /// The page's origin as a name, which is Unified Dev's half of anything a page raises. The rule is
