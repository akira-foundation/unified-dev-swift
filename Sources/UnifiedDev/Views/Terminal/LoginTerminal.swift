...
/// Keeping the process in Unified Dev avoids the Automation permission needed to control Terminal.app.
...
final class LoginTerminalSession {
    ...
    init?(
        ...
        launch = TerminalLaunch(
            ...
            // An empty folder avoids macOS asking about home-directory access in Unified Dev's name.
