...
extension Notification.Name {
    ...
    static let unifieddevPaneResizeBegan = Notification.Name("unifieddev.paneResize.began")
    static let unifieddevPaneResizeEnded = Notification.Name("unifieddev.paneResize.ended")
}
...
final class TranscriptHoldView: NSView {
    ...
    /// Whether a divider is known to be under a hand. See `unifieddevPaneResizeBegan`.
    ...
    init(scroll: NSScrollView) {
        ...
        centre.addObserver(
            self, selector: #selector(handTookHold), name: .unifieddevPaneResizeBegan, object: nil
        )
        centre.addObserver(
            self, selector: #selector(handLetGo), name: .unifieddevPaneResizeEnded, object: nil
        )
    }
