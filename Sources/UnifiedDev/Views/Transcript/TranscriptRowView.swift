...
struct TranscriptRowView: View, Equatable {
    ...
    private var content: some View {
        ...
        case .user:
            ...
            //
            // Nothing is taken out for the instructions Unified Dev appends. They stay in the text and
    ...
    /// A user turn is the line Unified Dev itself wrote to stdin, so it is read straight out of the
