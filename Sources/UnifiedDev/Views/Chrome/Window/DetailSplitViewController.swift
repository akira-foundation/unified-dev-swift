...
final class DetailSplitViewController: NSSplitViewController {
    ...
    // The narrowest this half of the window can be drawn is `UnifiedDevApp.widths.detailHalf`, and it
    ...
    private static let autosaveName = "unifieddev.detail.split"
    ...
    override func viewDidLoad() {
        ...
        // every semantic colour inside the pane then resolves to its vibrant variant. Unified Dev's
    ...
    private func makeRoomForInspector(animated: Bool) {
        ...
        let fit = UnifiedDevApp.widths.presenting(
...
struct DetailSplitView: NSViewControllerRepresentable {
    ...
    func sizeThatFits(
        ...
        let minimum = UnifiedDevApp.widths.detailHalf(withInspector: isInspectorPresented)
        return CGSize(
