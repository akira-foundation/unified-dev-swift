...
/// Unified Dev.
///
/// The owner asked for it. Unified Dev already has Help's Submit a Prompt, and a menu item is a feature
...
struct WelcomePromptSubmission: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: Metrics.pane - Metrics.spacingSmall) {
            ...
            // read as pages of one window: a display line, then the sentence explaining it at the
