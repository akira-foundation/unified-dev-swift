...
struct DirectorySettingsSection: View {
    ...
    var body: some View {
        ...
        Section("Ask Unified Dev") {
            folderRow("Working directory", path: preferences.ask, fallback: "Unified Dev’s own folder",
                      message: "Choose the working directory for new Ask Unified Dev conversations.") {
                preferences.ask = $0
            }
