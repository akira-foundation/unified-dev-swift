        ...
        Form {
            ...
            Section("Keep Awake") {
                ...
                Toggle(isOn: $keepAwake.keepsLidClosed) {
                    ...
                    Text("Needs Unified Dev's helper, approved once in System Settings.")
                }
                switch sleepSwitch.standing {
                case .ready:
                    Label(
                        "Unified Dev's helper is approved. Sleep is restored when the session ends, or if Unified Dev crashes.",
                ...
                case .needsApproval:
                    HStack {
                        Text("Allow Unified Dev's helper to finish switching this on.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                        Spacer()
