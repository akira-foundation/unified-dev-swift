...
/// Help ▸ Send Feedback. What is not working, what is missing, and optionally what Unified Dev said to
...
struct FeedbackSheet: View {
    ...
    private func readLogs() {
        ...
        // The names this Mac uses for its own work, which Core cannot know and this view can:
