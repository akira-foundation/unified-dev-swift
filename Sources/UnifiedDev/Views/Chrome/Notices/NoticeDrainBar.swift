...
final class NoticeDrainBarView: NSView {
    ...
    /// Faster than the twelve frames a second other capped animations in this app have used, and
    /// for a reason those do not have: they move soft fields whose brightest pixel changes by
