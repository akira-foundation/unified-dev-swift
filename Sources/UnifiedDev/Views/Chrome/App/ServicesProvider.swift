...
/// Turns text selected in any other app into a Unified Dev workspace, through the system Services menu.
///
...
/// arrive while Unified Dev has no window on screen at all, and a sheet needs one to hang from.
@MainActor
