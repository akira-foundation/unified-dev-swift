...
///
///     Unified Dev --snapshot-gallery <dir> --gallery composer-pickers
///
...
///
/// The Codex column is also the whole of the Plan question. Unified Dev has a Plan mode, Codex has
