...
/// The controls Unified Dev does not draw, drawn.
///
///     Unified Dev --snapshot-gallery <dir> --gallery system-accent
///
/// Every other page in this folder photographs something in `Sources/UnifiedDev`. This one photographs
/// AppKit beside Unified Dev's custom interactive surfaces. Both now resolve through
/// `controlAccentColor`: the bundle accent supplies Unified Dev's default under Multicolour, and an
