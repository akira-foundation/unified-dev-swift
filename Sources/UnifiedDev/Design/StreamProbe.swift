...
/// Measures the two states Unified Dev actually spends its day in: somebody typing, and an agent
/// writing.
///
...
/// handler, at a fixed rate. Not a real agent: `UD_LIVE` costs money, a model's pace is not
/// repeatable, and what is being measured is what Unified Dev does with a delta rather than how fast one
...
///
///     Unified Dev --stream-probe /tmp/stream.json --stream-workspace <id>
