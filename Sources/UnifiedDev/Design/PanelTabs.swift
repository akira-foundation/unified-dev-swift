...
struct PanelTabs<Tab: Hashable>: View {
    ...
    /// and measures 3.95 to 1, while `Palette.textTertiary` is Unified Dev's own retuned rung at 4.52.
    /// The system's second rung is below Unified Dev's third, and its own doc comment says as much.
    ///
