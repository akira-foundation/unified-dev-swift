    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            row("A browser mid load: the name it came from, then the host it went to", tabs: [
                fixture(
                    BrowserTabTitle.title(
                        page: BrowserTabTitle.advance(
                            from: .init(address: "https://akira-io.com/", title: "Akira"),
                            to: .init(address: "https://akira-io.com/open-source")
                        ).title,
                        address: "https://akira-io.com/open-source",
                        fallback: "Browser"
                    ),
                    PaneGlyph.browser,
                    active: true
                ...
                fixture(
                    BrowserTabTitle.title(
                        page: BrowserTabTitle.advance(
                            from: .init(address: "https://akira-io.com/", title: "Akira"),
                            to: .init(address: "https://github.com/akira-io")
                        ).title,
                        address: "https://github.com/akira-io",
                        fallback: "Browser"
                    ),
                    PaneGlyph.browser
                ),
            ...
            row("Browser tabs, wearing what the page gave them", tabs: [
                page(
                    BrowserTabTitle.title(
                        page: "Akira", address: "https://akira-io.com/", fallback: "Browser"
                    ),
                    Self.redMark,
                    active: true
                ),
                page(
                    BrowserTabTitle.title(
                        page: "akira-io/laravel-backup",
                        address: "https://github.com/akira-io/laravel-backup",
                        fallback: "Browser 2"
                    ),
                    Self.darkMark
                ),
