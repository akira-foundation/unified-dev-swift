...
enum RepoIconArt {
    ...
    /// a path Unified Dev is already showing can become a different picture. A file edited on disk
    /// outside Unified Dev is picked up at the next launch: watching every project's icon for changes
    ...
    /// shape underneath is `#000`. Unified Dev's own document is exactly that shape; the bug was hidden
