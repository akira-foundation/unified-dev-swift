...
/// The dialog Unified Dev asks a yes-or-no question in, drawn by Unified Dev rather than by AppKit.
///
...
struct ConfirmationSheet: View {
    ...
    var body: some View {
        ...
        // captures against Unified Dev's own surfaces: in light it comes out a neutral grey a step
    ...
    ///
    /// The system's `.bordered` button with the tone painted on, rather than a control of Unified Dev's
    ...
    // then inside Unified Dev itself, on the real merge confirmation, against a `gh` that logged what
