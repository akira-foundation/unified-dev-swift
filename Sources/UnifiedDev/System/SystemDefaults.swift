...
/// The preferences about how Unified Dev behaves as a piece of the operating system, and the one place
/// their defaults are stated.
///
...
///
/// Registration exists because these keys are each read from more than one place and the reads are
/// not all `@AppStorage`. The menu bar item is AppKit and asks `UserDefaults` directly, where a
