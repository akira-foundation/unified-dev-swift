...
enum FeedbackImages {
    ...
    private nonisolated static func read(_ source: AttachmentSource) throws -> FeedbackImage {
        ...
        case .text(_, let name):
            // Feedback is a screenshot and a sentence. Text Unified Dev generated for an agent to read,
...
///
/// **Nothing here writes to Unified Dev's log.** Every other part of the app that gives up quietly says
...
enum FeedbackClient {
    ...
    private static func post(
        ...
        do {
            ...
            // printed into Unified Dev's own interface.
