...
/// without it Unified Dev would be taken down by an agent CLI exiting mid-call. With it the write
...
public final class UnixSocketConnection: Sendable {
    ...
    ///
    /// No retry and no wait. The ordinary reason this fails is that Unified Dev has quit and somebody is
