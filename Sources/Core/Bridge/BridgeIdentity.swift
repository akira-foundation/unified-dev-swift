...
public enum BridgeRole: String, Sendable, Hashable, Codable, CaseIterable {
    ...
    /// it. It is the person, reaching Unified Dev from a `claude` they started themselves in a terminal
    /// anywhere on the machine, with Unified Dev registered in their own MCP configuration.
    ///
