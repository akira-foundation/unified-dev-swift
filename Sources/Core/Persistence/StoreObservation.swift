...
/// update hook is per connection and Unified Dev opens the same file twice: the app's `Store` and
...
/// hub extends that to every connection in this process, and no further. Unified Dev and Unified Dev (Dev) are
