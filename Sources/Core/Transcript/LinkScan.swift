...
///    like Unified Dev's fault.
///
/// **What it deliberately refuses.**
///
/// - A bare host with no scheme: `example.com`, `www.example.com`, `akira-io.com`. Recognising those
...
///   `git@github.com:akira-io/unifieddev.git`, and turning a git remote into a link in a tool row is a
