...
///
/// Unified Dev stores a message as the raw JSON line the agent CLI emitted, and there are four of those
...
public enum TranscriptSearchText {
    ...
    /// snake case and Unified Dev is not going to arbitrate.
    ///
