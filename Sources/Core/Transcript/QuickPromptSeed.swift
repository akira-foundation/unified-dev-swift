...
/// The quick prompts a fresh copy of Unified Dev starts with, and the rule that stops a deleted one from
/// coming back.
///
...
/// back again?" with "because Unified Dev puts it there every time you start it". Instead each built-in
...
public enum QuickPromptSeed {
    ...
    public static let all: [Entry] = [
        // The one Unified Dev ships with. It is deletable, like everything else here, and deleting it
