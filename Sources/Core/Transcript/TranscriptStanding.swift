...
/// What a session Unified Dev was writing to turns out to be, asked once a write has already failed.
///
...
public enum TranscriptStanding: Sendable, Equatable {
    ...
    /// The database's complaint without the statement Unified Dev built to provoke it.
    ///
