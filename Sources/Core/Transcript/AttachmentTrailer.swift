...
///
///     Attached file:
///     - .unifieddev/attachments/9JVKW4/IMG_4395.jpeg
///
/// The part that has not changed is the path. Every agent Unified Dev can run reads files by path, so a
...
///
/// Unified Dev does not draw it as a list either, and a list of paths in a speech bubble was a worse
