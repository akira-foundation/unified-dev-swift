...
public enum InspectorTab: String, Hashable, CaseIterable, Sendable {
    ...
    /// every check Unified Dev knows about comes out of the `statusCheckRollup` of a single
    ...
    /// workflow may trigger on `push`, and the day Unified Dev asks GitHub for those the answer this
