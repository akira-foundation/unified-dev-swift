...
/// carries.
///
/// **It is the source of truth rather than a description of one.** `AppCommands` is a
...
public enum MenuBarCatalogue {
    ...
    public static let commands: [MenuBarItem] = [
        ...
        // that appears while Ask Unified Dev is open, which is a control you have to already be looking
        // at to find: the owner asked whether Unified Dev could clear an Ask conversation at all, and it
...
/// The menus Unified Dev contributes items to.
///
/// Window is not here. Everything in it is SwiftUI's and AppKit's, and the one thing Unified Dev used to
...
public enum MenuBarAvailability: String, Equatable, Sendable {
    ...
    case needsWorkspace
    /// A workspace or Ask Unified Dev is selected.
