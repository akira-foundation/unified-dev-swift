...
/// and every decision in it inside the app target, where `Tests/CoreTests` cannot reach.
...
public enum ToolTint: String, Sendable, Hashable, CaseIterable {
    ...
    case neutral
    /// It is Unified Dev's own doing, or a search this window will show the results of.
    case accent
