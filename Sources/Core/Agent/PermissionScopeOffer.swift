...
/// in a worktree. Ask Unified Dev is not. `permission_grants.repo_id` is `NOT NULL REFERENCES repos(id)`,
...
public struct PermissionScopeOffer: Sendable, Hashable {
    ...
    ///   Unified Dev, and it is the whole reason this takes an optional rather than a name and a flag: a
