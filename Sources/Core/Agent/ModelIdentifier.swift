...
/// runs it.
///
/// Model ids are an open set, and deliberately so. One reaches Unified Dev verbatim from places Unified Dev
...
/// names a backend Unified Dev actually has.
///
...
public struct ModelIdentifier: Equatable, Sendable {
    ...
    /// The three spellings of a backend a file could reasonably use: the key Unified Dev stores, the
