...
///
/// **This is the `deliveries` queue in `unifieddev-handover/mcp-design.md`, not a second one beside
...
/// for the rows Unified Dev draws about a workspace. It becomes a `messages` row at the moment it goes,
...
public struct Delivery: Identifiable, Sendable, Hashable {
    ...
    /// A delivery of something one agent said to another, or of Unified Dev's word about one of them.
    ///
