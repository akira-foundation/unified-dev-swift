...
public struct ComposerControls: Equatable, Sendable {
    ...
    /// Whether this chat has a worktree behind it. False is Ask Unified Dev, and it is here rather than
    ...
    /// Every other chat in Unified Dev is in a worktree, which is a copy of a project cut for the
