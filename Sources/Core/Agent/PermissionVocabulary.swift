...
///
/// **A user opened the Codex app beside Unified Dev and could not match up the two menus.** Unified Dev's
...
/// are the vendors' own rather than Unified Dev's summaries of them.
///
