...
/// Everything that decides whether Unified Dev may rename the branch it cut a few seconds ago.
///
...
public struct BranchRenameFacts: Sendable, Hashable {
    ...
    /// Unified Dev or GitHub knows of a pull request for this branch.
...
public enum BranchRenameRefusal: Sendable, Hashable {
    ...
    /// thought: "Unified Dev named this workspace Dark mode toggle. The branch is still
