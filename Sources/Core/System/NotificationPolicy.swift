...
///
/// Two facts, because two is all it takes: whether Unified Dev is the app in front of the user, and
...
/// preference when somebody reports that Unified Dev went quiet.
...
public enum NotificationPolicy {
    public static func verdict(
        ...
        // while Unified Dev is the active app, and those are exactly the ones worth saying something
        // about.
