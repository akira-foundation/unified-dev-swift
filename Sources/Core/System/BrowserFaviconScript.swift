...
/// The two things Unified Dev asks a page about its own icon.
///
...
/// whatever it likes, and the answer ends up drawn inside Unified Dev's own chrome.
///
/// **The page rasterises, Unified Dev does not decode.** `image` draws the icon into a canvas Unified Dev
