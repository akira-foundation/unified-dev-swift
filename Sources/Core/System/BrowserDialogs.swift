...
/// is chrome the reader trusts. A page that writes "Unified Dev needs your GitHub token" into an alert
/// is doing the oldest trick there is, and the answer every browser reached is the same: Unified Dev's
...
public struct BrowserDialogs: Sendable, Equatable {
    ...
    public struct Presentation: Sendable, Equatable {
        /// Unified Dev's own line, naming who is speaking.
    ...
    /// Unified Dev's own line above the page's words.
    ///
