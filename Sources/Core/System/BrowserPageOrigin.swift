...
///
/// A page can raise two things that look like they came from Unified Dev: a file panel, and (once the
/// dialogs land) an alert. Both are chrome the reader trusts, and a page that writes "Unified Dev needs
...
/// sentence the reader sees says which site asked, in Unified Dev's words, above whatever the page
/// wrote.
///
...
public enum BrowserPageOrigin {
    ...
    /// serve `/Unified Dev Support: enter your token/` and have it appear in the sentence), and the
