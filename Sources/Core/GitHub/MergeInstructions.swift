...
/// How Unified Dev lands a pull request, in the words the agent reads.
///
...
/// `.unifieddev/scratch/merge-instructions.md` and attached that back, so the turn could say "follow
