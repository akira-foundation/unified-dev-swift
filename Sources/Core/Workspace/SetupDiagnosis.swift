...
/// string the C library itself printed rather than by anything Unified Dev guessed:
///
...
public struct SetupDiagnosis: Sendable, Hashable {
    ...
    /// What the script exited with, when Unified Dev watched the run. Nil for a workspace reopened long
