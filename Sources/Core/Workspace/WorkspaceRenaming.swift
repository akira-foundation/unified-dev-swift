...
extension WorkspaceManager {
    ...
    /// Applies a suggestion to a workspace that is still wearing the placeholder Unified Dev gave it.
    ///
    ...
    ///
    /// - Parameter placeholder: the exact name Unified Dev wrote at creation. The rename is abandoned
