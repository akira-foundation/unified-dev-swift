...
/// reason is the whole point of this tool existing: Unified Dev hands a merge to the workspace's own
...
///
/// Every sentence says whether retrying helps, names no path inside Unified Dev's own worktree root, and
/// quotes no command line Unified Dev built.
