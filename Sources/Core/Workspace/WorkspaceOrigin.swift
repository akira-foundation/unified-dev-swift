...
///
/// A workspace an agent asked for is an ordinary Unified Dev workspace with an ordinary agent in it.
...
public enum WorkspaceOrigin: Sendable, Equatable, Hashable, Codable {
    /// The owner, through the sheet, a `unifieddev://` link, the Services menu or a Shortcut.
    case user
    ...
    public init(parentWorkspaceID: String?, spawnToolUseID: String?) {
        ...
        // of Unified Dev that did not know about the second column, or by hand. It reads as the owner's,
