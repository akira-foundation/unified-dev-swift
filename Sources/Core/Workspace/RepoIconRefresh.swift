...
/// front of it: "is this a folder Unified Dev is allowed to go and look at again". They are separate
...
///
/// `.detected` is Unified Dev's own guess and is therefore the one that could be revisited, but a
