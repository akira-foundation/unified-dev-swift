...
description: Write and review Unified Dev Swift concurrency code for actor isolation, task lifetime, cancellation and stream correctness.
license: MIT
metadata:
  author: Paul Hudson
...
# Swift concurrency in Unified Dev

Check `Package.swift` and the actual target's compiler flags before inferring isolation. Unified Dev
