---
name: swiftui-pro
description: Write and review Unified Dev macOS SwiftUI views for data flow, accessibility, API correctness and measured performance.
license: MIT
metadata:
  author: Paul Hudson
  version: "1.1-unifieddev.1"
  adapted-for: Unified Dev
---

# SwiftUI in Unified Dev

Unified Dev targets macOS 26 and Swift 6.2, as declared in `Package.swift`. Follow `CLAUDE.md` for
...
- [Design](references/design.md): Unified Dev's design system and native Mac layout.
