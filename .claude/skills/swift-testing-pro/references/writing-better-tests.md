...
Follow the existing `Tests/CoreTests` layout and fixture helpers. The test target cannot
import SwiftUI or the app; test decisions through Core. UI rendering or automation requires
...
Never test against the owner's Unified Dev database or preferences. Unit tests should use controlled
