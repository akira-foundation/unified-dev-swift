...
/// Unified Dev's own steps for resolving a conflict, and the file they go in.
///
...
struct ConflictInstructionsTests {
    ...
    /// `ProjectInstructions` already writes `.unifieddev/scratch/conflict-instructions.md` for the
