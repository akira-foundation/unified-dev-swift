...
/// would.
///
/// **The second way a dying child took Unified Dev down, found by this suite.** The first CI run of it
...
/// exiting mid-call would take Unified Dev down, and the pipe to a child had never been given the same
