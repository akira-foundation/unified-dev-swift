...
struct RunScriptNoticeTests {
    ...
    private let file = "/Users/someone/code/maintainly/.unifieddev/settings.toml"
    ...
    func oneIssue() throws {
        ...
        #expect(notice.title == "1 entry in .unifieddev/settings.toml was skipped")
    ...
    func severalIssues() throws {
        ...
        let notice = try #require(SettingsIssuesNotice.make(issues: issues))
        #expect(notice.title == "4 entries in .unifieddev/settings.toml were skipped")
    ...
    func unreadableFile() throws {
        ...
        let notice = try #require(SettingsIssuesNotice.make(issues: issues))
        #expect(notice.title == ".unifieddev/settings.toml could not be read")
    }
