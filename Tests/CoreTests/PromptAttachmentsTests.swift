...
struct PromptAttachmentsTests {
    ...
    /// Inside the worktree, under Unified Dev's own corner of it, because the agent has to be able to
    /// read it without being asked for permission Unified Dev cannot answer.
