...
struct BrowserFaviconTests {
    ...
    func originIgnoresThePath() {
        #expect(BrowserFavicon.origin(of: "https://akira-io.com/open-source")
            == BrowserFavicon.origin(of: "https://akira-io.com/docs/laravel-backup"))
    }

    @Test("The port is filled in, so the same site written two ways is one key")
    func defaultPortIsExplicit() {
        #expect(BrowserFavicon.origin(of: "https://akira-io.com/") == "https://akira-io.com:443")
        #expect(BrowserFavicon.origin(of: "https://akira-io.com:443/") == "https://akira-io.com:443")
    ...
    @Test("The host is compared in one case", arguments: [
        "https://Akira-IO.COM/", "https://akira-io.com/",
    ])
    ...
    func linksAreReadInFours() {
        let links = BrowserFavicon.links(from: [
            "icon", "32x32", "image/png", "https://akira-io.com/icon.png",
            "apple-touch-icon", "", "", "https://akira-io.com/touch.png",
        ])
        #expect(links.count == 2)
        #expect(links[0] == link("icon", "https://akira-io.com/icon.png", sizes: "32x32", type: "image/png"))
    ...
    func otherRelsAreIgnored(rel: String) {
        #expect(BrowserFavicon.choose(from: [link(rel, "https://akira-io.com/icon.png")]) == nil)
    }
