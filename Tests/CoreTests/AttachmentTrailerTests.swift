...
struct AttachmentTrailerTests {
    ...
    func roundTrips() {
        let cases: [(String, [String])] = [
            ("look at this", [".unifieddev/attachments/9JVKW4/IMG_4395.jpeg"]),
    ...
    func keepsNamesWithSpaces() {
        let path = ".unifieddev/attachments/aB3xY9/CleanShot 2026-08-19 at 00.04.38@2x.jpg"
