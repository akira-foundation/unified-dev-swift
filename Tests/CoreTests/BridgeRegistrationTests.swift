...
struct BridgeSocketPathTests {
    ...
    func fitsInTheRealPlace() throws {
        let path = try BridgeSocketPath.derive(databasePath: "/Users/someone/Library/Application Support/Unified Dev/unifieddev.sqlite")
...
struct BridgeRegistrationTests {
    ...
    func theNameIsCollisionProof() {
        ...
        #expect(BridgeRegistration.serverName != "unifieddev")
        #expect(BridgeRegistration.serverName.contains("unifieddev"))
    }
