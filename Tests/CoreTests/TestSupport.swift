...
/// `unifieddev-unscoped-` directories and 219 template roots** in its temporary directory. That is a
...
struct TempRepo {
    ...
    /// `~/unifieddev/workspaces` on the machine where it was found. Reading the worktree list here
