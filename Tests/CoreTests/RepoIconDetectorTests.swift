...
struct RepoIconDetectorTests {
    ...
    func unifieddevItself() throws {
        // Four levels up from Tests/CoreTests/<this file>. Symlinks resolved first, because
        ...
        let root = URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .path
        // A layered document, because that is the only icon Unified Dev ships now. The flat AppIcon.icns
