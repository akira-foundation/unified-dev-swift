...
/// ruler it was measured with was the local `main`, which Unified Dev never moves and which was still
...
struct BaselineTests {
    ...
    /// every repository Unified Dev is ever pointed at.
    ...
    /// A repository with no remote at all, which Unified Dev supports everywhere else.
