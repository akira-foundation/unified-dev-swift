...
struct GitReliabilityTests {
    ...
    func metadataWatchRoots() async throws {
        ...
        let ignored = WorktreeWatcher.metadataWorktrees(changed: [
            ...
            WorktreeWatcher.resolve(first.commonDirectory) + "/refs/unifieddev/checkpoints/turn/worktree",
            WorktreeWatcher.resolve(first.commonDirectory) + "/logs/refs/unifieddev/checkpoints/turn/worktree",
            WorktreeWatcher.resolve(first.gitDirectory) + "/unifieddev-snapshot-turn-index",
            WorktreeWatcher.resolve(first.gitDirectory) + "/unifieddev-restore-temporary",
        ], metadata: metadata)
