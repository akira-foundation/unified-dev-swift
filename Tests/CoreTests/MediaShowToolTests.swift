...
struct MediaShowToolTests {
    ...
    @Test("only Unified Dev's own media tool becomes inline content")
    ...
    func containment() throws {
        let root = FileManager.default.temporaryDirectory
            .appending(path: "unifieddev-media-\(UUID().uuidString)", directoryHint: .isDirectory)
        let outside = FileManager.default.temporaryDirectory
            .appending(path: "unifieddev-outside-\(UUID().uuidString).png")
