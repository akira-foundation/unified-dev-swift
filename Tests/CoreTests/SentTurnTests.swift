...
/// How a turn Unified Dev composed is cut up for the bubble that draws it.
///
...
struct SentTurnTests {
    ...
    /// A turn an older Unified Dev sent is still in the database and still has to draw.
    ...
    /// A block is Unified Dev's only where Unified Dev put it, which is at the head of a paragraph. Quoted in
