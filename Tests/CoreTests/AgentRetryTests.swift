...
///
/// **The wording is tested because the wording is the feature.** What Unified Dev says about a 529 is
...
@Suite struct AgentRetryTests {
    ...
    /// there is nothing more useful to say about one Unified Dev has not met.
...
/// The `rate_limit_event` that rides along in the same capture, and the figure Unified Dev used to
/// invent from it.
...
@Suite struct TurnFailureTests {
    ...
    /// An ending Unified Dev has no reading of does not get a sentence pretending otherwise.
