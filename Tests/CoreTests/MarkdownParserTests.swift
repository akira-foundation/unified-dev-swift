...
struct MarkdownParserTests {
    ...
    func pathIsNotAnAddress() {
        #expect(MarkdownParser.parse("edited Sources/UnifiedDev/Views/Transcript/UserTurnRowView.swift") == [
            .paragraph(inline: [.text("edited Sources/UnifiedDev/Views/Transcript/UserTurnRowView.swift")]),
        ])
    }
