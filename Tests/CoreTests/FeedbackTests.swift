...
struct FeedbackEmailTests {
    ...
    func reportCarriesTheAddress() throws {
        #expect(try object(report(email: "freek@akira-io.com"))["email"] as? String == "freek@akira-io.com")
    }

    @Test("a prompt submission carries it too")
    func promptCarriesTheAddress() throws {
        #expect(try object(submission(email: "freek@akira-io.com"))["email"] as? String == "freek@akira-io.com")
    }
    ...
    func logsCheckboxMemory() throws {
        let suite = "io.akira.unifieddev.tests.\(UUID().uuidString)"
