...
struct AttachmentDraftTests {
    ...
    static let drafts: [(draft: String, known: [String], paths: [String])] = [
        ...
        ("`.unifieddev/attachments/9JVKW4`", [], []),
        ("`.unifieddev/attachments/`", [], []),
    ...
    func copiesNeedNoTelling() {
        ...
        #expect(!AttachmentDraft.isAttachment(".unifieddev/attachments/9JVKW4"))
        #expect(!AttachmentDraft.isAttachment(".unifieddev/attachments/9JVKW4/"))
        #expect(!AttachmentDraft.isAttachment(".unifieddev/attachments//shot.png"))
